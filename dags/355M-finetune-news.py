...
from tfx_gpt2.templates.local_finetune_local_ckpt_pipeline import create_pipeline
...
train_config = {'num_iterations': 1000000,  # number of iterations
                ...
                'sample_every': 100000,  # Generate samples every N steps
                'sample_length': 1023,  # Sample this many tokens
                'sample_num': 10,  # Generate this many samples
                'save_every': 100000,  # Write a checkpoint every N steps
                }
